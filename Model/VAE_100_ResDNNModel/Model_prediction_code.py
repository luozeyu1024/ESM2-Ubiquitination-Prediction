...
best_params = pd.read_excel(open_path + r"\ESM2-Ubiquitination-Prediction\Model\VAE_100_ResDNNModel\best_hyperparameters.xlsx")
...
model.load_state_dict(torch.load(open_path + r"\ESM2-Ubiquitination-Prediction\Model\VAE_100_ResDNNModel\VAE_100_ResDNNModel.pth"))
model.to(device)
